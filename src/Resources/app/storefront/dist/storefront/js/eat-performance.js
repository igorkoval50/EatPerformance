...
$('.table-headline').on('click', function () {
    $(this).siblings(".product-table-wrapper").slideToggle();
    $(this).toggleClass('toggle-rotate');
});

$('.product-headline-tablet').on('click', function () {
    $('.container-product-block').slideToggle();
    $(this).toggleClass('toggle-rotate');
});

$('.product-headline-box-tablet').on('click', function () {
    $('.container-tablet ').slideToggle();
    $(this).toggleClass('toggle-rotate');
});
